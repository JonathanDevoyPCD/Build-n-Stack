...
- `assets/images/` — replaceable sprite locations
...
Gameplay values are grouped and documented near the top of `script.js`. The complete player experience is capped at `768px` via `--game-max-width` near the top of `style.css`.
